...
def audio_dep(file):
    json_file = open('/home/rragarwa/depression-detect/model.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    # load weights into new model
    loaded_model.load_weights("/home/rragarwa/depression-detect/Emotion_Voice_Detection_Model.h5")
...
print(audio_dep("/home/rragarwa/Downloads/js-segment-annotator-rishav/data/annotations/no-3.wav"))
